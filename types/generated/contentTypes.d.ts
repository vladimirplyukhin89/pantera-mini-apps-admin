...
export interface ApiClubValueClubValue extends Struct.CollectionTypeSchema {
  collectionName: 'club-values';
  info: {
    displayName: 'Club Value';
    pluralName: 'club-values';
    singularName: 'club-value';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accent_index: Schema.Attribute.Integer;
    ...
    event_at: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    statusPlan: Schema.Attribute.Enumeration<['planned', 'past']> &
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    video_cover: Schema.Attribute.Media<'images'>;
  };
}

export interface ApiGalleryPhotoGalleryPhoto
  extends Struct.CollectionTypeSchema {
  collectionName: 'gallery-photos';
  info: {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variant: Schema.Attribute.Enumeration<['default', 'tall', 'wide']>;
  };
}
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bg_desktop: Schema.Attribute.Media<'images'>;
    bg_mobile: Schema.Attribute.Media<'images'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::club-value.club-value': ApiClubValueClubValue;
